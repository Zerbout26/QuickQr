    ...
    const downloadWithLogo = async () => {
      ...
      try {
        ...
        if (format === 'svg') {
          ...
          qrContainer.style.width = `${design.qrSize}px`;
          qrContainer.style.height = `${design.qrSize}px`;
          qrContainer.style.position = 'relative';
          qrContainer.style.backgroundColor = design.qrBgColor;
          qrContainer.style.borderRadius = design.borderRadii.inner;
          qrContainer.style.padding = `${design.frameWidth}px`;
          qrContainer.style.boxShadow = `0 15px 35px ${design.primaryColor}30`;
          qrContainer.style.border = `2px solid ${design.primaryColor}50`;
          ...
          const qrCode = new QRCode(qrContainer, {
            ...
            colorDark: design.qrFgColor,
            colorLight: design.qrBgColor,
          ...
          await new Promise<void>((resolve) => {
            setTimeout(() => {
              ...
              if (qrCanvas) {
                // Create a new canvas for the QR code section
                const qrSectionCanvas = document.createElement('canvas');
                const qrSectionCtx = qrSectionCanvas.getContext('2d');
                
                // Set canvas size to include frame
                const totalSize = design.qrSize + (design.frameWidth * 2);
                qrSectionCanvas.width = totalSize;
                qrSectionCanvas.height = totalSize;
                
                if (qrSectionCtx) {
                  // Draw white background
                  qrSectionCtx.fillStyle = design.qrBgColor;
                  qrSectionCtx.fillRect(0, 0, totalSize, totalSize);
                  
                  // Draw QR code
                  qrSectionCtx.drawImage(qrCanvas, design.frameWidth, design.frameWidth, design.qrSize, design.qrSize);
                  
                  // Draw frame corners
                  qrSectionCtx.strokeStyle = design.secondaryColor;
                  qrSectionCtx.lineWidth = 5;
                  
                  // Top-left corner
                  qrSectionCtx.beginPath();
                  qrSectionCtx.moveTo(design.frameWidth, design.frameWidth + design.cornerSize);
                  qrSectionCtx.lineTo(design.frameWidth, design.frameWidth);
                  qrSectionCtx.lineTo(design.frameWidth + design.cornerSize, design.frameWidth);
                  qrSectionCtx.stroke();
                  
                  // Top-right corner
                  qrSectionCtx.beginPath();
                  qrSectionCtx.moveTo(totalSize - design.frameWidth - design.cornerSize, design.frameWidth);
                  qrSectionCtx.lineTo(totalSize - design.frameWidth, design.frameWidth);
                  qrSectionCtx.lineTo(totalSize - design.frameWidth, design.frameWidth + design.cornerSize);
                  qrSectionCtx.stroke();
                  
                  // Bottom-left corner
                  qrSectionCtx.beginPath();
                  qrSectionCtx.moveTo(design.frameWidth, totalSize - design.frameWidth - design.cornerSize);
                  qrSectionCtx.lineTo(design.frameWidth, totalSize - design.frameWidth);
                  qrSectionCtx.lineTo(design.frameWidth + design.cornerSize, totalSize - design.frameWidth);
                  qrSectionCtx.stroke();
                  
                  // Bottom-right corner
                  qrSectionCtx.beginPath();
                  qrSectionCtx.moveTo(totalSize - design.frameWidth - design.cornerSize, totalSize - design.frameWidth);
                  qrSectionCtx.lineTo(totalSize - design.frameWidth, totalSize - design.frameWidth);
                  qrSectionCtx.lineTo(totalSize - design.frameWidth, totalSize - design.frameWidth - design.cornerSize);
                  qrSectionCtx.stroke();
                  
                  // Draw scan line
                  qrSectionCtx.beginPath();
                  qrSectionCtx.moveTo(design.frameWidth, totalSize / 2);
                  qrSectionCtx.lineTo(totalSize - design.frameWidth, totalSize / 2);
                  qrSectionCtx.strokeStyle = design.secondaryColor;
                  qrSectionCtx.lineWidth = 4;
                  qrSectionCtx.stroke();
                  
                  // Convert to PNG and download
                  const pngUrl = qrSectionCanvas.toDataURL('image/png', 1.0);
                  const downloadLink = document.createElement('a');
