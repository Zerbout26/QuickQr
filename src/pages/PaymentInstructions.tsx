        ...
        <Card className="overflow-hidden rounded-2xl shadow-2xl border-none bg-white/95 backdrop-blur-sm">
          <CardContent className="p-8 md:p-10">
            <div className="flex flex-col items-center mb-6">
              ...
              <h1 className="text-3xl font-extrabold text-center mb-2 tracking-tight text-primary">Subscription Required</h1>
            ...
            <div className="mb-8">
              <h2 className="text-xl font-semibold mb-4 flex items-center text-secondary">
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-6 border border-gray-100">
                ...
                <div className="mb-4">
                  <h3 className="font-medium mb-2 text-secondary">Bank Transfer</h3>
                ...
                <div className="mb-4">
                  <h3 className="font-medium mb-2 text-secondary">Mobile Payment</h3>
                  <ul className="list-disc list-inside text-sm pl-2 space-y-1 text-gray-700">
                ...
                <div className="mb-2">
                  <h3 className="font-medium mb-2 text-secondary">In-Person Payment</h3>
            ...
            <div className="flex flex-col gap-4 pt-2">
              ...
              <a href="mailto:support@quickqr.dz">
                <Button className="w-full bg-secondary hover:bg-secondary/90 text-white flex items-center gap-2">
                  Contact Support
