          ...
          {links.map((link, index) => {
            ...
            return (
              <motion.a
                ...
                className={`flex items-center justify-center gap-2 px-3 py-2.5 rounded-lg text-white font-medium shadow-md transition-all duration-300 text-sm sm:text-base sm:px-4 sm:py-3 w-full sm:w-[calc(50%-0.75rem)]`}
                style={{ 
                  background: bgColor,
